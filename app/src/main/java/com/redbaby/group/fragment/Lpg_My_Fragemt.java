...
public class Lpg_My_Fragemt extends Fragment {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 0) {
                final String my = (String) msg.obj;

                Gson gson = new Gson();
                final MuYingBean bean = gson.fromJson(my, MuYingBean.class);
                //设置适配器
                MyMuYingAdapter myMuYingAdapter = new MyMuYingAdapter(bean, getContext());
                ...
                myMuYingAdapter.setOnItemClickLitsener(new HengRecyclerViewAdapter.onItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        intent.putExtra("img", bean.getEnrolls().getList().get(position).getImgUrl());
